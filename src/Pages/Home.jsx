...
const WORDS = ["Backend Developer", "Cloud Engineer", "Machine Learning Enginer", "Tech Enthusiast"];
const TECH_STACK = ["PHP", 'Laravel', "Node.js", "C#", "ASP.NET", "Python", "Tensorflow", "GCP", "Azure"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/RanoLangari" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/ranolangari/" },
  { icon: Instagram, link: "https://www.instagram.com/ranolangari/?hl=id" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  I am a passionate Backend Developer with a strong interest in Cloud Computing and Machine Learning. I have experience in developing web applications, RESTful APIs, and machine learning models. I am also familiar with cloud platforms such as Google Cloud Platform and Microsoft Azure.
                </p>
